# Claudiar Implementation Plan

## Overview

Claudiar is an autonomous development automation system that bridges Linear project management with Claude Code. When you move a Linear issue to "Todo", Claudiar automatically picks it up, creates an isolated git worktree, runs Claude Code to implement the task, and manages the full lifecycle through PR creation.
...
2. Linear webhook → Claudiar server (via ngrok)
3. Claudiar:
